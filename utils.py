...
def get_auth_cred():
    """
    Returns api object make twitter search calls
    Return
    ----------
...
def get_tweets_from_muted_and_unmuted(tweet_file_name,muted_file_name):
    """ Reads the muted file and archive tweets file and returns final list of tweeets
    ...
    limit=400
    t2=get_tweets_from_un_muted(mute_set,tweet_dic,limit)
...
def process_status(currentid,user_nm,api):
    ...
    while(currentid!=None):
        ...
        #print(dic)
        last_dic=dic
        display_y=tweet.user.screen_name!=user_nm
